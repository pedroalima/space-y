    ...
    <div className='row justify-content-md-around'>
        <div className='col-12 col-md-5 text-center pt-4'>
            <figure className="figure">
                <img src={imageTitan} className="figure-img img-fluid rounded image-custom" alt="The titan" />
            </figure>
        </div>
        <div className='col-12 col-md-5'>
            <section className="jumbotron bg-transparent py-0 px-0 py-md-0 my-md-0">
                ...
                <h3 className="display-4 pt-3 font-primary-family text-uppercase font-primary-color font-letter-space">{data.destinations[3].name}</h3>
                <p className='font-secondary-color font-tertiary-family pb-4 pb-md-5 border-bottom border-secondary'>{data.destinations[3].description}</p>
                <ul className='list-group flex-md-row justify-content-start'>
                    <li className='list-group-item bg-transparent pl-md-0 border-0'>
                        ...
                        <h4 className='font-primary-family font-primary-color font-letter-space text-uppercase'>{data.destinations[3].distance}</h4>
                    </li>
                    <li className='list-group-item bg-transparent border-0'>
                        <h6 className='font-secondary-family font-secondary-color font-letter-space text-uppercase'>Est. travel time</h6>
                        <h4 className='font-primary-family font-primary-color font-letter-space text-uppercase'>{data.destinations[3].travel}</h4>
                    </li>
                </ul>
            </section>
        </div>
