    ...
    return (
        <div className='container-fluid' id='home'>
            <div className='container'>
                <div className='row min-vh-100 d-flex justify-content-center py-md-5 px-md-5 align-items-center justify-content-md-between align-items-md-end'>
                    ...
                    <div className='col-6 col-md-3 text-center'>
                        <Link className="font-primary-family text-uppercase font-tertiary-color font-letter-space" id='explorer' to="/destination">
                            <div className='jumbotron rounded-circle bg-white'>
                                <span>Explore</span>
                            </div>
                        </Link>
                    </div>
